...
export default function TransfertMode() {
    ...
    const transferExpiryDate = useMemo(() => {
                        ...
                        {!transferGenerated ? (
                            ...
                            <div className="fade-in">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, background: 'var(--neutral-50)', padding: 16, borderRadius: 'var(--radius-md)', marginTop: 16 }}>
                                    ...
                                    <div style={{ fontSize: 11, display: 'flex', justifyContent: 'space-between' }}><span>Expiration</span><span style={{ fontWeight: 600 }}>{transferExpiryDate}</span></div>
